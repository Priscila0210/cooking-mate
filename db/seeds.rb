...
user3 = User.create!(nickname: "Marcel", email: "marcel@test.com", password: "123456", address: "Roma", age: 40, description: Faker::Lorem.paragraph_by_chars(number: 51, supplemental: false), interested_in: "open to anything", cooking_level: "some experience", availability: ["weekdays", "weekend"])
...
user4 = User.create!(nickname: "Eduardo", email: "eduardo@test.com", password: "123456", address: "Roma", age: 40, description: Faker::Lorem.paragraph_by_chars(number: 51, supplemental: false), interested_in: "open to anything", cooking_level: "some experience", availability: ["weekdays", "weekend"])
...
user5 = User.create!(nickname: "Priscila", email: "priscila@test.com", password: "123456", address: "Roma", age: 40, description: Faker::Lorem.paragraph_by_chars(number: 51, supplemental: false), interested_in: "open to anything", cooking_level: "some experience", availability: ["weekdays", "weekend"])
...
recipe2 = Recipe.new(title: "Caccio e pepe", description: "Mama's recipe which requires only 4 ingredients and takes 15 minutes to make! A perfect weeknight pasta dish thats's super indulgent.", length: 2, level_of_difficulty: "easy", cuisine: Cuisine.first, user: User.last)
...
recipe3 = Recipe.new(title: "Burrito", description: "Everyday Beef Burrito recipe, stuffed with a simpler, super tasty seasoned beef filling, rice and other fillings of choice.", length: 3, level_of_difficulty: "medium", cuisine: Cuisine.first, user: User.last)
...
recipe4 = Recipe.new(title: "Bacalau", description: "Portuguese style", length: 7, level_of_difficulty: "hard", cuisine: Cuisine.last, user: User.first)
...
recipe5 = Recipe.new(title: "Coxinhas", description: "Chicken croquettes shaped into a chicken drumstick and fried until crispy and golden brown. It's popular Brazilian street food!", length: 4, level_of_difficulty: "medium", cuisine: Cuisine.last, user: User.first)
...
recipe6 = Recipe.new(title: "Paella", description: "The taste of Spain", length: 7, level_of_difficulty: "hard", cuisine: Cuisine.last, user: User.first)
...
recipe7 = Recipe.new(title: "Schnitzel", description: "Authentic German Schnitzel just the way your favorite German restaurants make it! A fool-proof recipe for absolute PERFECTION!", length: 4, level_of_difficulty: "medium", cuisine: Cuisine.last, user: User.first)
...
recipe8 = Recipe.new(title: "Crème brulée", description: "The sweet of Paris. Et voilà!", length: 2, level_of_difficulty: "easy", cuisine: Cuisine.last, user: User.first)
...
recipe9 = Recipe.new(title: "Shrimp and Asparagus Pasta", description: "This classic spring pasta dish combines the fresh, seasonal flavor of asparagus with sweet, tender shrimp.", length: 2, level_of_difficulty: "easy", cuisine: Cuisine.last, user: User.first)
...
recipe15 = Recipe.new(title: "Best Mac and Cheese", description: "This homemade mac and cheese is our Platonic ideal: It is deeply cheesy and creamy and has a crunchy crust. Plus, it doubles easily for a crowd.", length: 2, level_of_difficulty: "easy", cuisine: Cuisine.last, user: User.first)
...
recipe16 = Recipe.new(title: "Pasta e Fagiolini", description: "This tomatoey vegetarian pasta from Southern Italy makes the most of green beans.", length: 2, level_of_difficulty: "easy", cuisine: Cuisine.last, user: User.first)
...
recipe17 = Recipe.new(title: "Chocolate Pie With Press-In Crust", description: "Destined to be your go-to chocolate pie recipe for any and all occasions.", length: 2, level_of_difficulty: "easy", cuisine: Cuisine.last, user: User.first)
...
recipe18 = Recipe.new(title: "Cheesy Pork and Tomatillo Skillet", description: "Teamed up with chips, this dip is the most popular snack in town. Or be like us and call it dinner.", length: 2, level_of_difficulty: "easy", cuisine: Cuisine.last, user: User.first)
...
recipe19 = Recipe.new(title: "Lemon Meringue Pie", description: "A sky-high pie with sharp lemon filling, sweet-and-salty meringue, and a shatteringly crisp crust.", length: 2, level_of_difficulty: "easy", cuisine: Cuisine.last, user: User.first)
...
recipe20 = Recipe.new(title: "Hot Spiced Apple Cider", description: "This easy recipe for homemade apple cider doubles as aromatherapy.", length: 2, level_of_difficulty: "easy", cuisine: Cuisine.last, user: User.first)
